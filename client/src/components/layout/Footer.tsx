      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="space-y-6">
            <h3 className="font-display text-2xl font-bold tracking-tighter">VÉLURE</h3>
          ...
          <div className="space-y-4">
            <h4 className="text-xs uppercase tracking-widest font-semibold text-primary-foreground/80">Corporate</h4>
            <ul className="space-y-3 text-sm text-primary-foreground/60">
        ...
        <div className="mt-16 md:mt-24 pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-primary-foreground/40">
          <p>&copy; {new Date().getFullYear()} Vélure Fashion. All rights reserved.</p>
