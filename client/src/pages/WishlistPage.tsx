        ...
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 space-y-6 opacity-60">
            ...
            <div className="text-center">
              ...
              <Link href="/" data-testid="link-start-shopping" className="inline-block border border-foreground px-8 py-3 text-xs uppercase tracking-widest font-semibold hover:bg-foreground hover:text-background transition-all">
                Start Shopping
              </Link>
            </div>
          </div>
