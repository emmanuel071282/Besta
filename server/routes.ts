...
async function seedDatabase() {
  try {
    ...
    if (existingProducts.length > 0) {
      const hasSubcategory = existingProducts.some(p => p.subcategory && p.subcategory !== "");
    ...
    const seedData = [
      ...
      { name: "Oversized Graphic Tee", description: "Relaxed oversized tee with vintage-inspired graphic print.", price: "999", imageUrl: "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?q=80&w=800&auto=format&fit=crop", category: "Ladies", subcategory: "Tops" },
      ...
      { name: "Pleated Midi Skirt", description: "Elegant pleated midi skirt in satin finish with elastic waistband.", price: "2199", imageUrl: "https://images.unsplash.com/photo-1583496661160-fb5886a0uj12?q=80&w=800&auto=format&fit=crop", category: "Ladies", subcategory: "Skirts" },
